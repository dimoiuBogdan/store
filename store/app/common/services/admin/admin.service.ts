import type { AdminBestProductModel } from "@/app/[locale]/(pages)/admin/components/AdminSections/AdminBestProductsSection/types/admin-best-products-section.types";
import type {
  AdminOrderDetailsModel,
  AdminOrderedProductModel,
} from "@/app/[locale]/(pages)/admin/components/AdminSections/AdminLatestOrdersSection/AdminLatestOrdersDetailsPopup/types/admin-latest-orders-details-popup.types";
import type { AdminLatestOrderModel } from "@/app/[locale]/(pages)/admin/components/AdminSections/AdminLatestOrdersSection/types/admin-latest-orders-section.types";
import type { AdminOverviewModel } from "@/app/[locale]/(pages)/admin/components/AdminSections/AdminOverviewSection/types/admin-overview-section.types";
import type { AdminBestCategoriesModel } from "@/app/[locale]/(pages)/admin/components/AdminSections/AdminTopCategoriesSection/types/admin-best-categories-section.types";
